...
* `visual_rich_enrichments` (id, visual_asset_id, run_id [nullable], asset_category [nullable], map_scale_declared [nullable], orientation [nullable], legibility_score [nullable], interpretation_notes [nullable], tool_run_id [nullable], metadata_jsonb, created_at)
* `visual_rich_layers` (id, enrichment_id, visual_asset_id, run_id [nullable], layer_name [nullable], layer_type [nullable], representation_style [nullable], color_hex_guess [nullable], is_legend_item [nullable], tool_run_id [nullable], metadata_jsonb, created_at)
* `visual_rich_toponyms` (id, visual_asset_id, run_id [nullable], toponym, tool_run_id [nullable], created_at)
* `visual_rich_policy_codes` (id, visual_asset_id, run_id [nullable], policy_code, tool_run_id [nullable], created_at)
...
* `context_packs` (id, run_id, move_type, work_mode, authority_id [nullable], plan_cycle_id [nullable], plan_project_id [nullable], scenario_id [nullable], application_id [nullable], selector_id [nullable], pack_jsonb, tool_run_id [nullable], created_at)
...
* `spatial_layers` (id, authority_id [nullable], ingest_batch_id [nullable], layer_name, layer_type [nullable], source_url [nullable], local_path [nullable], geometry_type [nullable], feature_count [nullable], bbox [nullable], metadata_jsonb, tool_run_id [nullable], created_at)
...
* `advice_card_instances` (id, card_id, card_version [nullable], scope_type, scope_id, status, trigger_cues_jsonb [nullable], evidence_refs_jsonb [nullable], tool_run_id [nullable], created_at, notes [nullable])
