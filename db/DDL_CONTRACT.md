...
* `visual_assets` (id, document_id, page_number, ingest_batch_id [nullable], run_id [nullable], source_artifact_id [nullable], asset_type, blob_path, metadata)
...
* `policy_clauses` (id, policy_section_id, run_id [nullable], clause_ref [nullable], text, page_number [nullable], span_start [nullable], span_end [nullable], span_quality [nullable], speech_act_jsonb, subject [nullable], object [nullable], evidence_ref_id [nullable], source_artifact_id [nullable], metadata_jsonb)
